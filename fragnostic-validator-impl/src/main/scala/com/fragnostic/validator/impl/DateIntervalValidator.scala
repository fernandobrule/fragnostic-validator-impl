...
class DateIntervalValidator extends ValidatorApi[(String, String)] with ValidatorSupport with ValidatorMessagesKeys {
  ...
  override def validate(locale: Locale, domain: String, dateInterval: (String, String), params: Map[String, String], messages: Map[String, String], mandatory: Boolean = true): Validated[(String, String)] = {
    ...
    val msgStart: Map[String, String] = Map(
      ...
      MSG_STRING_VALIDATOR_STRING_IS_NULL -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_NULL}_$domainStart", MSG_STRING_VALIDATOR_STRING_IS_NULL),
      MSG_STRING_VALIDATOR_STRING_IS_EMPTY -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_EMPTY}_$domainStart", MSG_STRING_VALIDATOR_STRING_IS_EMPTY),
      MSG_STRING_VALIDATOR_STRING_IS_TOO_SHORT -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_TOO_SHORT}_$domainStart", MSG_STRING_VALIDATOR_STRING_IS_TOO_SHORT),
      MSG_STRING_VALIDATOR_STRING_IS_TOO_LONG -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_TOO_LONG}_$domainStart", MSG_STRING_VALIDATOR_STRING_IS_TOO_LONG) //
    )
    ...
    val msgEnd: Map[String, String] = Map(
      ...
      MSG_STRING_VALIDATOR_STRING_IS_NULL -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_NULL}_$domainEnd", MSG_STRING_VALIDATOR_STRING_IS_NULL),
      MSG_STRING_VALIDATOR_STRING_IS_EMPTY -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_EMPTY}_$domainEnd", MSG_STRING_VALIDATOR_STRING_IS_EMPTY),
      MSG_STRING_VALIDATOR_STRING_IS_TOO_SHORT -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_TOO_SHORT}_$domainEnd", MSG_STRING_VALIDATOR_STRING_IS_TOO_SHORT),
      MSG_STRING_VALIDATOR_STRING_IS_TOO_LONG -> messages.getOrElse(s"${MSG_STRING_VALIDATOR_STRING_IS_TOO_LONG}_$domainEnd", MSG_STRING_VALIDATOR_STRING_IS_TOO_LONG) //
    )
