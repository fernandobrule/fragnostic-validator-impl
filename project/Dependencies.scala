...
object Dependencies {
  ...
  lazy val fragnosticValidatorApi     = "com.fragnostic"        % "fragnostic-validator-api_2.13"  % "0.3.4"
  lazy val fragnosticConfFacade       = "com.fragnostic"         %  "fragnostic-conf-facade_2.13"  % "0.2.6" % Test
